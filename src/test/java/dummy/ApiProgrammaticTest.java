...
@QuarkusTest
class ApiProgrammaticTest {
  private static final Logger LOGGER = Logger.getLogger(ApiProgrammaticTest.class);
  ApiClientProgrammatic apiClient = null;

  @BeforeEach
  void beforeEach() {
    if (apiClient == null) {
      apiClient = new ApiClientProgrammatic();
    }
  }
